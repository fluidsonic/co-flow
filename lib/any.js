 ...
 * @param  {function}          [options.unusedResultHandler=false]  Callback for each runnable whose result was not returned by the function.
	...
	return function(callback) {
		...
		function complete() {
			...
			if (options.structured) {
				result = utility.wrapResult(error, data);
			}
		...
		function onRunnableCompleted(index, error, data) {
			...
			let result = utility.wrapResult(error, data);
